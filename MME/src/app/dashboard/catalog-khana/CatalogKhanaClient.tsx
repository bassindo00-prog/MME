...
export function CatalogKhanaClient({ data }: { data: CatalogKhana[] }) {
    ...
    <div className="animate-fade-in max-w-7xl mx-auto pb-10">
      <div className="mb-8">
        <h1 className="text-3xl md:text-4xl font-black text-gray-900 tracking-tight flex items-center gap-3">
          <FileAudio className="w-8 h-8 text-blue-600" /> Katalog Khana
        </h1>
        <p className="text-gray-500 mt-2 font-medium">Jelajahi daftar lagu dari PT Khana Media Nusantara.</p>
      </div>
