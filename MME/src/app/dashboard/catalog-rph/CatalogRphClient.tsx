...
export function CatalogRphClient({ data }: { data: CatalogRph[] }) {
    ...
    <div className="animate-fade-in max-w-7xl mx-auto pb-10">
      <div className="mb-8">
        <h1 className="text-3xl md:text-4xl font-black text-gray-900 tracking-tight flex items-center gap-3">
          <FileAudio className="w-8 h-8 text-blue-600" /> Katalog RPH
        </h1>
        <p className="text-gray-500 mt-2 font-medium">Jelajahi daftar lagu lengkap dari RPH.</p>
      </div>
              ...
              <div className="mt-auto space-y-2">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-gray-700 line-clamp-1" title={item.singer}>{item.singer}</p>
                  </div>
                </div>
